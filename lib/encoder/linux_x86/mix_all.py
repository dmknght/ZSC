...
def start(shellcode, job):
    encodes = ['add_random', 'sub_random', 'xor_random', 'inc_timesyouwant',
               'dec_timesyouwant']
    ...
    if 'chmod' == job:
        ...
        if selected == 'add_random':
            ...
            while t:
                if _version == 2:
                    ecx_1 = binascii.b2a_hex(''.join(random.choice(chars)
                                                     for i in range(4)))
                if _version == 3:
                    ecx_1 = (binascii.b2a_hex((''.join(random.choice(
                        chars) for i in range(4))).encode('latin-1'))
                             ).decode('latin-1')
                ecx_2 = "%x" % (int(ecx_value, 16) - int(ecx_1, 16))
                if '00' not in str(ecx_1) and '00' not in str(ecx_2) and len(
                        ecx_1) >= 7 and len(ecx_2) >= 7 and '-' in ecx_2:
                    t = False
            ecx_2 = ecx_2.replace('-', '')
            ecx_xor = 'push $0x%s\npop %%ebx\npush $0x%s\npop %%ecx\nneg %%ecx\nadd %%ecx,%%ebx\npush %%ebx\n_z3r0d4y_\n' % (
                str(ecx_1), str(ecx_2))
        ...
        if selected == 'sub_random':
            ...
            while t:
                ...
                ecx_2 = "%x" % (int(ecx_value, 16) + int(ecx_1, 16))
                if '00' not in str(ecx_1) and '00' not in str(ecx_2) and len(
                        ecx_1) >= 7 and len(ecx_2) >= 7 and '-' not in ecx_2:
                    t = False
            ecx_xor = 'push $0x%s\npop %%ebx\npush $0x%s\npop %%ecx\nsub %%ebx,%%ecx\npush %%ecx\n_z3r0d4y_\n' % (
                str(ecx_1), str(ecx_2))
            shellcode = shellcode.replace(ecx, ecx_xor)
            ...
            for l in middle.rsplit('\n'):
                ...
                while t:
                    if 'push $0x' in l:
                        ...
                        if '00' not in str(ebx_1) and '00' not in str(
            ...
            for l in middle.rsplit('\n'):
                ...
                while t:
                    if 'push $0x' in l:
                        ...
                        ebx_2 = "%x" % (int(ebx[2:], 16) + int(ebx_1, 16))
                        if '00' not in str(ebx_1) and '00' not in str(
                                ebx_2) and '-' not in ebx_2 and len(
                                    ebx_2) >= 7 and len(
                                        ebx_1) >= 7 and '-' not in ebx_1:
                            ebx_2 = ebx_2.replace('-', '')
                            command = '\npush $0x%s\npop %%ebx\npush $0x%s\npop %%edx\nsub %%ebx,%%edx\npush %%edx\n' % (
        ...
        if selected == 'dec_timesyouwant':
            ...
            shellcode = shellcode.replace('push   $0xb\npop    %eax\ncltd',
                                          eax_add + '\ncltd\n')
        encodes = ['add_random', 'sub_random', 'xor_random',
                   'inc_timesyouwant', 'dec_timesyouwant']
        selected = random.choice(encodes)
        if selected == 'add_random':
            for line in shellcode.rsplit('\n'):
                if 'push' in line and '$0x' in line and ',' not in line and len(
                    ...
                    while t:
                        ...
                        if str('00') not in str(ebx_1) and str(
                                '00') not in str(
                                    ebx_2) and '-' in ebx_2 and len(
                                        ebx_2) >= 7 and len(
                                            ebx_1) >= 7 and '-' not in ebx_1:
    ...
    if 'write' == job:
        ...
        if selected == 'add_random':
            ...
            while t:
                ...
                if eax_1 != eax:
                    if eax > eax_1:
                        if str('00') not in str(eax_1) and str('0') not in str(
                                eax_2):
                            t = False
            A = 0
            eax = 'push   $%s' % (str(eax))
        ...
        if selected == 'sub_random':
            ...
            while t:
                ...
                if eax_1 != eax:
                    if eax > eax_1:
                        if str('00') not in str(eax_1) and str(
                                '00') not in str(eax_2):
                            t = False
            A = 0
            eax = 'push   $%s' % (str(eax))
                ...
                if A == 0:
                    if 'push' in line and '$0x' in line and ',' not in line and len(
                        ...
                        while t:
                            ...
                            if _version == 3:
                                ebx_1 = (
                                    binascii.b2a_hex((''.join(random.choice(
                                        chars) for i in range(4))).encode(
                            ...
                            if ebx_1 != data and str('00') not in str(
                                ...
                                if '-' not in ebx_2 and t == True:
                                    ...
                                    shellcode = shellcode.replace(line,
                                                                  command)
                                    t = False
            shellcode = shellcode.replace('_z3r0d4y_', '').replace(
                '_z3r0|d4y_', '')
        if selected == 'sub_random':
            A = 1
            for line in shellcode.rsplit('\n'):
